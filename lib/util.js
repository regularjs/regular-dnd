...
let dom = Regular.dom;
let supportTouch = 'ontouchstart' in document && !('onmousedown' in document); 

let MOUSE_DOWN = supportTouch? 'touchstart': 'mousedown';
let MOUSE_MOVE = supportTouch? 'touchmove': 'mousemove';
let MOUSE_UP = supportTouch? 'touchend': 'mouseup';
